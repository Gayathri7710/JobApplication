...
<head>
    ...
    <style>
        ...
        .sidebar {
            width: 220px;
            background-color: #493743; /* Black background */
            position: fixed;
            height: 100%;
            overflow: auto;
            text-align: center;
...
<div class="sidebar">
    ...
    <a href="studentreg">Register User</a>
    <a href="viewallstudents">View All Users</a>
    <a href="managerreg">Register Recruiter</a>
    <a href="viewallmanagers">View All Recruiters</a>
    <a href="addevent">Register Job Application</a>
    
    <a href="deletestudent">Delete User</a>
    <a href="deletemanager">Delete Recruiter</a>
    <a href="adminlogout">Logout</a>
</div>

<div class="content">
    <h2 align="center">Career Link</h2>
</div>
